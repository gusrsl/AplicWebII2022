...
const actualizarProducto = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const productoModificado = yield models_1.Producto.findByIdAndUpdate(id, data, { new: true });
    res.json(productoModificado);
});
const borrarProducto = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const productoBorrado = yield models_1.Producto.findByIdAndUpdate(id, { estado: false }, { new: true });
